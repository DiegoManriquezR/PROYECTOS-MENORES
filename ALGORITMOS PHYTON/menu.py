...
class Aplicacion(tk.Tk):
    ...
    def __init__(self):
        ...
        tk.Label(self.frame, text="Bienvenido al Sistema", font=("Helvetica", 16, "bold"), bg="#ffffff").pack(pady=10)
    ...
    def crear_botones(self):
        estilo_boton = {'bg': '#00796b', 'fg': 'white', 'font': ('Helvetica', 12, 'bold'), 'width': 20}
    ...
    def inicio_sesion(self):
        ...
        ventana_sesion.configure(bg="#e0f7fa")

        tk.Label(ventana_sesion, text="Iniciar Sesión", font=("Helvetica", 16, "bold"), bg="#e0f7fa").pack(pady=10)

        tk.Label(ventana_sesion, text="RUT (con punto y guión):", bg="#e0f7fa").pack(pady=5)
        entry_rut = tk.Entry(ventana_sesion)
        entry_rut.pack(pady=5)

        tk.Label(ventana_sesion, text="Contraseña:", bg="#e0f7fa").pack(pady=5)
        ...
        tk.Button(ventana_sesion, text ="Aceptar", command=manejar_inicio_sesion, bg='#00796b', fg='white', font=('Helvetica', 12, 'bold')).pack(pady=10)
    ...
    def ventana_consulta_indicadores(self):
        ...
        ventana_consulta.configure(bg="#e0f7fa")

        tk.Label(ventana_consulta, text="Consulta de Indicadores", font=("Helvetica", 16, "bold"), bg="#e0f7fa").pack(pady=10)

        tk.Label(ventana_consulta, text="Fecha (DD-MM-YYYY):", bg="#e0f7fa").pack(pady=5)
        ...
        self.resultados_frame = tk.Frame(ventana_consulta, bg="#e0f7fa")
        ...
        tk.Button(ventana_consulta, text="Consultar", command=consultar_indicadores_button, bg='#00796b', fg='white', font=('Helvetica', 12, 'bold')).pack(pady=10)
        tk.Button(ventana_consulta, text="Guardar Indicadores", command=self.msg_ind, bg='#00796b', fg='white', font=('Helvetica', 12, 'bold')).pack(pady=10)

        def volver_al_inicio():
            ventana_consulta.destroy()

        tk.Button(ventana_consulta, text="Volver", command=volver_al_inicio, bg='#00796b', fg='white', font=('Helvetica', 12, 'bold')).pack(pady=10)
    ...
    def mostrar_resultados(self, resultado):
        ...
        tk.Label(self.resultados_frame, text="Resultados de Indicadores:", bg="#e0f7fa").pack(pady=5)

        label_resultado = tk.Label(self.resultados_frame, text=resultado, bg="#e0f7fa")
    ...
    def registrar_usuario(self):
        ...
        ventana_registro.configure(bg="#e0f7fa")

        tk.Label(ventana_registro, text="Registrar Usuario", font=("Helvetica", 16, "bold"), bg="#e0f7fa").pack(pady=10)

        tk.Label(ventana_registro, text="RUT(con punto y guión):", bg="#e0f7fa").pack(pady=5)
        entry_rut = tk.Entry(ventana_registro)
        entry_rut.pack(pady=5)

        tk.Label(ventana_registro, text="Nombre:", bg="#e0f7fa").pack(pady=5)
        entry_nombre = tk.Entry(ventana_registro)
        entry_nombre.pack(pady=5)

        tk.Label(ventana_registro, text="Apellido:", bg="#e0f7fa").pack(pady=5)
        entry_apellido = tk.Entry(ventana_registro)
        entry_apellido.pack(pady=5)

        tk.Label(ventana_registro, text="Contraseña:", bg="#e0f7fa").pack(pady=5)
        ...
        ), bg='#00796b', fg='white', font=('Helvetica', 12, 'bold')).pack(pady=10)

        tk.Button(ventana_registro, text="Volver", command=ventana_registro.destroy, bg='#00796b', fg='white', font=('Helvetica', 12, 'bold')).pack(pady=10)
